...
: ViewWidget(p_view_ID, p_parent)
{
    ...
    connect(&GData::getUniqueInstance(), SIGNAL(onChunkUpdate()), m_vibrato_speed_widget, SLOT(doUpdate()));
    connect(&GData::getUniqueInstance(), SIGNAL(onChunkUpdate()), m_vibrato_circle_widget, SLOT(doUpdate()));
    connect(&GData::getUniqueInstance(), SIGNAL(onChunkUpdate()), m_vibrato_period_widget, SLOT(doUpdate()));
    connect(&(GData::getUniqueInstance().getView()), SIGNAL(onFastUpdate(double)), m_vibrato_time_axis, SLOT(update()));
    connect(&(GData::getUniqueInstance().getView()), SIGNAL(onFastUpdate(double)), m_vibrato_widget, SLOT(updateGL()));
