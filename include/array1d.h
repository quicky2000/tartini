...
class Array1d
{
  ...
  */
  Array1d(int p_length, const T &p_val);
  ...
  */
  Array1d(const T *p_src, int p_length);
  ...
  */
   ...
   */
  void resize(int p_new_size, const T &p_val);
  ...
  /**
     ...
     @param p_length The amount of data to copy and the new size of this array.
  */
  void resize_copy(const T *p_src, int p_length);
